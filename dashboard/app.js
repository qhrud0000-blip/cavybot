...
const DEFAULT_BOARD = [
  ...
  },
  {
    ...
    title: "🗂️ 내 프로젝트 지침",
    items: [
      { id: "pi-readme", label: "📚 지침 인덱스", url: "../프로젝트-지침/README.md", cta: true },
      { id: "pi-persona", label: "공통 페르소나", url: "../프로젝트-지침/00-공통-페르소나.md" },
      { id: "pi-sub-c", type: "sub", label: "Claude 프로젝트" },
      { id: "pi-iyb", label: "인스타/유튜브/블로그", url: "../프로젝트-지침/07-claude-인스타-유튜브-블로그.md" },
      { id: "pi-daily", label: "일일업무·사업계획 대시보드", url: "../프로젝트-지침/08-claude-일일업무자동화-사업계획-대시보드.md" },
      { id: "pi-field", label: "분야별 자동화 AI 기획", url: "../프로젝트-지침/09-claude-분야별-자동화-AI기획.md" },
      { id: "pi-detail", label: "상품상세페이지 자동화", url: "../프로젝트-지침/10-claude-상품상세페이지-자동화.md" },
      { id: "pi-sub-g", type: "sub", label: "ChatGPT 프로젝트" },
      { id: "pi-aira", label: "아이라(화장품)", url: "../프로젝트-지침/01-아이라-화장품콘텐츠.md" },
      { id: "pi-shorts", label: "쇼핑쇼츠", url: "../프로젝트-지침/02-쇼핑쇼츠.md" },
      { id: "pi-lyric", label: "가사", url: "../프로젝트-지침/03-가사.md" },
      { id: "pi-vibe", label: "바이브코딩강의", url: "../프로젝트-지침/04-바이브코딩강의.md" },
      { id: "pi-legal", label: "법률 사건관리", url: "../프로젝트-지침/05-법률-2026카합10269.md" },
      { id: "pi-pw", label: "비밀번호(보안)", url: "../프로젝트-지침/06-비밀번호.md" },
    ],
  },
  {
    id: "content",
...
async function fetchJson(path) {
  if (window.__INLINE__ && window.__INLINE__[path]) return window.__INLINE__[path];
